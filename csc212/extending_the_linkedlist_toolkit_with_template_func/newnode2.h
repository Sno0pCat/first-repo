// FILE: node2.h (part of the namespace csc212_proj3)
...
//   template <class Item>
//   size_t list_occurrences(const node<Item>* head_ptr, const node::value_type& target)
//     Precondition: head_ptr is the head pointer of a linked list.
...
//
//   void list_tail_attach(node<Item>*& head_ptr, const node::value_type& entry)
//     Precondition: head_ptr is the head pointer of a linked list.
//     Postcondition: A new node containing the given entry has been added at
...
//     is unchanged.
//
//   node* list_copy_front(const node<Item>* source_ptr, size_t n)
...
namespace csc212_proj2
{
    ...
    template <class Item>
    size_t list_occurrences(const node<Item>* head_ptr, const Item& target);
    ...
    template <class Item>
    node<Item>* list_copy_front(const node<Item>* source_ptr, std::size_t n);

}

#include "newnode2.template"
#endif
